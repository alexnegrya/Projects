...
class _Tour:
    ...
    def calculate_cost(self):
        ...
        for c in range(len(self.tourists)):
            if self.tourists[c].age in range(7, 16): procent = 75
            elif self.tourists[c].age <= 6: procent = 50
            else: procent = 0
            ...
            if procent != 0: self.cost += value / 100 * procent
            else: self.cost += value
        return self.cost
...
class TourBuilder:
    ...
    def build(self): return self._tour
